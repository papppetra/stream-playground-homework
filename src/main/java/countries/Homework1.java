...
public class Homework1 {
    ...
    public void streamPipeline8() {
        countries.stream().sorted(Comparator.comparing(country -> country.getTimezones().size())).map(country -> country.getName()+" : "+country.getTimezones().size()).forEach(System.out::println);
    }
